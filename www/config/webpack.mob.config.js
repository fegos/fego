...
BUILD_PATH = path.resolve(ROOT_PATH, 'www/build/mobile'),
...
resolve: {
	...
	// 默认使用mob相关的库文件
	extensions: ['.mob.js', '.mob.jsx', '.js', '.jsx'],
	alias: {
		src: SRC_PATH,
		fego: FEGO_PATH,
...
module: {
	rules: [{
		...
		exclude: [
			path.resolve(SRC_PATH, 'mobile/sys')
		]
	}, {
		test: /\.less?$/,
		use: ExtractTextPlugin.extract({
...
plugins: [
	...
	new HtmlWebpackPlugin({
		template: path.resolve(SRC_PATH, 'mobile/index.html'),
